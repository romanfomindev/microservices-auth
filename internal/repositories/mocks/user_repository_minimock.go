...
type UserRepositoryMock struct {
	...
	funcGetByEmail          func(ctx context.Context, email string) (up1 *models.User, err error)
...
func (mmGetByEmail *mUserRepositoryMockGetByEmail) Return(up1 *models.User, err error) *UserRepositoryMock {
	if mmGetByEmail.mock.funcGetByEmail != nil {
		mmGetByEmail.mock.t.Fatalf("UserRepositoryMock.GetByEmail mock is already set by Set")
	}
...
func (mmGetByEmail *mUserRepositoryMockGetByEmail) Set(f func(ctx context.Context, email string) (up1 *models.User, err error)) *UserRepositoryMock {
	if mmGetByEmail.defaultExpectation != nil {
...
func (e *UserRepositoryMockGetByEmailExpectation) Then(up1 *models.User, err error) *UserRepositoryMock {
	e.results = &UserRepositoryMockGetByEmailResults{up1, err}
	return e.mock
}

// GetByEmail implements repositories.UserRepository
func (mmGetByEmail *UserRepositoryMock) GetByEmail(ctx context.Context, email string) (up1 *models.User, err error) {
